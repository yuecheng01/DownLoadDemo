package com.yeucheng.downloaddemo.permission;
...
public class PermissionHelper {
    ...
    //链式的方式传递
    //传activity
    private static PermissionHelper with(Activity activity) {
        return new PermissionHelper(activity);
    }

    //传fragment
    private static PermissionHelper with(Fragment fragment) {
        return new PermissionHelper(fragment);
    }

    //传FragmentActivity
    private static PermissionHelper with(FragmentActivity activity) {
        return new PermissionHelper(activity);
    }
    ...
    //传请求权限
    private PermissionHelper requestPermission(String... permisson) {
